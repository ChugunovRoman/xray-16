...
SCRIPT_EXPORT(CSE_ALifeTraderAbstract, (),
{
    ...
    [
        class_<CSE_ALifeTraderAbstract>("cse_alife_trader_abstract")
            ...
            .def("character_name", +[](CSE_ALifeTraderAbstract* ta) { return ta->character_name(); })
            .def("set_character_name", +[](CSE_ALifeTraderAbstract* ta, const pcstr str) { return ta->set_character_name(str); })
