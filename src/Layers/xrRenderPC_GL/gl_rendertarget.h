...
public:
    ...
    // consumes it. Lives until destroy()/SVPSmapAtlasRelease(). DX11-only in practice: Ensure
    // returns false on GL where there is nothing to record deferred lists into.
