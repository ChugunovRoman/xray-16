...
public:
    ...
    ID3DRenderTargetView* get_present_rt() { return (mrs_set.swapped ? mrs_set.orig_Base : rt_Base)[HW.CurrentBackBuffer]->pRT; }
    ID3DDepthStencilView* get_present_zb() { return (mrs_set.swapped ? mrs_set.orig_Base_Depth : rt_Base_Depth)->pZRT[CHW::IMM_CTX_ID]; }
