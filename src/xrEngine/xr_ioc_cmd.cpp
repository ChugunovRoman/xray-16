...
ENGINE_API float ps_r__hud_overlay_fov_scale = 0.4f; // overlay HUD FOV scale after ADS lerp: 1.0 = g_fov size, <1 larger
...
void CCC_Register()
{
    ...
    CMD4(CCC_Float, "r__hud_overlay_fov_scale", &ps_r__hud_overlay_fov_scale, 0.3f, 1.5f);
